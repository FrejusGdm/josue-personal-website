        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-20">
          ...
          >
            <div className="space-y-6 font-sans text-lg md:text-xl text-neutral-600 leading-relaxed">
              <p>
                I grew up in <SmartLink href="https://en.wikipedia.org/wiki/Benin" external previewText="A nation in West Africa, known as the birthplace of the Vodun religion and home to the Dahomey Amazons.">Benin</SmartLink>, a tiny country in West Africa. I ranked first in my national high school diploma (baccalauréat) with the 2nd highest score in the history of the exam in my country. This allowed me to attend <SmartLink href="https://dartmouth.edu" external previewText="An Ivy League research university in Hanover, New Hampshire.">Dartmouth College</SmartLink>, where I now study computer science and minor in Mandarin Chinese. I speak four languages—English, French, Chinese, and Adja. At Dartmouth, I am a <SmartLink href="https://kingphilanthropies.org/king-scholars/" external previewText="Leadership program for students from low-income countries committed to alleviating poverty.">King Scholar</SmartLink> and a <SmartLink href="https://www.stampsscholars.org/" external previewText="Merit scholarship program supporting leadership, scholarship, and service.">Stamps Scholar</SmartLink>.
              </p>
              <p>
