    ...
    <section className="relative w-full min-h-[90vh] flex items-center bg-white text-[#1a1612] px-6 md:px-12">
      <div className="max-w-[680px] mx-auto w-full py-24 md:py-32">
        ...
        >
          ...
          {[
            {
              href: "https://github.com/FrejusGdm",
              label: "GitHub",
              icon: (
            ...
            {
              href: "https://www.linkedin.com/in/josue-godeme-58abb2196/",
              label: "LinkedIn",
              icon: (
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 flex-shrink-0">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-sm text-[#1a1612]/40 hover:text-[#1a1612]/75 transition-colors"
              style={{ fontFamily: "var(--font-inter), sans-serif" }}
            >
              {icon}
              {label}
