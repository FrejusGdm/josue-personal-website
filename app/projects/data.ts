export const projects = [
  ...
  },
  {
    ...
    description:
      "Finds out who you actually know from your Gmail by scanning email threads, identifying real contacts, and enriching them with AI. Privacy-first and processed in-memory.",
